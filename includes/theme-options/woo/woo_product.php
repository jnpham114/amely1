		...
		'fields'     => array(
			...
			array(
				...
				'options' => array(
					...
					'image-slider'         => esc_html__( 'Image Slider', 'amely' ),
				),
				'default' => 'basic',
			),
			...
			array(
				...
				'options'  => array(
					'facebook'  => esc_html__( 'Facebook', 'amely' ),
					'twitter'   => esc_html__( 'Twitter', 'amely' ),
					'google'    => esc_html__( 'Google+', 'amely' ),
					'pinterest' => esc_html__( 'Pinterest', 'amely' ),
					'email'     => esc_html__( 'Email', 'amely' ),
				),
				'default'  => array(
					'facebook'  => '1',
					'twitter'   => '1',
