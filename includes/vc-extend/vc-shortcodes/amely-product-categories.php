...
class WPBakeryShortCode_Amely_Product_Categories extends WPBakeryShortCode {
	...
	public function subcategory_thumbnail( $category ) {
		...
		if ( isset( $atts['item_style'] ) && ( ( $atts['item_style'] == 'black-overlay' ) || ( $atts['item_style'] == 'white-overlay' ) ) ) {
	...
	'params'      => array(
		...
		array(
			...
			'value'       => array(
				...
				esc_html__( 'Style 3 - White overlay on mouse over', 'amely' )  => 'white-overlay',
			),
			'dependency'  => array(
				'element'            => 'layout',
